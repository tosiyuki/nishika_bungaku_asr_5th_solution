...
class ModelArguments:
    ...
    audio_tower: Optional[str] = field(default="openai/clip-vit-large-patch14-336")
    mm_audio_select_layer: Optional[int] = field(default=-2)   # default to the last two layer
    ...
    audio_encoder_type: str = field(default="CLIP")
